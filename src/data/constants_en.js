  ...
  const hero = {
    heroTittle: "Hi, I am",
    heroPresentation: "I am a ",
    heroButton: "Visit LinkedIn",
  };
  ...
  const skillsHeader = {
    tittle:"Skills",
    description:"Languages and skills that I have learned over the last 5 years"
  };
  ...
  const projects = [
    {
      ...
      date: "2020",
      description:
        "Creation and maintenance of a website in Wordpress. Then implementation of ecommerce for the sale of acoustic materials. Payments processed through Mercado Pago.",
      image:
    ...
    },
    {
      ...
      date: "2021",
      description:
        "WooCommerce Online Store for cosmetic and personal care products. Integration with Mercado Pago Checkout and design with Elementor Pro.",
      image:
    ...
    },
    {
      ...
      date: "2022",
      description:
        "Informative static page design with monthly updates of values, refunds and other services they offer.",
      image:
  ...
  const educationHeader = {
    tittle:"Education",
    description:"Learn about my educational path in the world of programming!"
  };
